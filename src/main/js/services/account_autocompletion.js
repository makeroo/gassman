...
function () {
    ...
    /**
     * Extract CSA available currencies from account index (returned by parse() method).
     *
     * @param accounts accountAutocompletion.parse() result
     * @returns Map from currency id to currency symbol.
     */
    this.available_currencies = function (accounts) {
        var currencies = {};

        angular.forEach(accounts, function (account) {
            currencies[account.cur[0]] = account.cur[1];
        });
