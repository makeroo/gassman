/**
 * @license AngularJS v1.3.0-local+sha.c94329a
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-local+sha.c94329a/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0-local+sha.c94329a',    // all of these placeholder strings will be replaced by grunt's
